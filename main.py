...
game_start= my_font.render("space bar if you are ready to start", True, (0,0,0))
time_left_display= my_font.render("Time left: " + str(time_left),True, (0,0,0) )
try_again_display= my_font.render("You lost, reload the game :(", True, (0,0,0))
...
while run :
   ...
   if time_run == True:
       ...
       if level == 3 and time_left != 0:
           time_left = float(round(3 - (end_time - start_time), 2))
           time_left_display = my_font.render("Time left: " + str(time_left), True, (0, 0, 0))
       if level == 4 and time_left != 0:
           time_left = float(round(2 - (end_time - start_time), 2))
           time_left_display = my_font.render("Time left: " + str(time_left), True, (0, 0, 0))
       if level == 5 and time_left != 0:
           time_left = float(round(1 - (end_time - start_time), 2))
           time_left_display = my_font.render("Time left: " + str(time_left), True, (0, 0, 0))
   ## ----- NO BLIT ZONE START ----- ##
   ...
   for event in pygame.event.get():
       ...
       if event.type == pygame.KEYDOWN:
        ...
        if c.rect.colliderect(red.rect) and gem == "Red" and time_left != 0:
          time_run = False
          win = True
          display_win = my_font.render("Onto the next level! CLICK TO CONTINUE", True, (0, 0, 0))
          display_level = my_font.render("level: " + str(level), True, (0, 0, 0))
   ...
   if click_start == True  and time_run == True  and lose != True:
